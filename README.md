...
| `/ball-collision-koota` | The same simulation with a Koota world, traits, systems, and actions. [Migrate from Zustand](src/demos/ball-collision-steps/05-koota/README.md). |
| `/ball-collision-steps` | Five runnable lessons with plain Markdown: renderer, drag and fling, walls, ball collisions, then Koota. [Start here](src/demos/ball-collision-steps/README.md). |
