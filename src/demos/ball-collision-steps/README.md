...
Start with [lesson 1](01-renderer/README.md) and edit the existing [src/demos/ball-collision](../ball-collision/) folder throughout all six lessons. Each guide shows every edit needed for the next step. The numbered lesson folders contain the completed examples.
...
6. [Refs](06-refs/README.md) reads Koota positions in each ball's frame callback and mutates the mesh without React position updates.
