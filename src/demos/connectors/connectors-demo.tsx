...
} from "@/demos/connectors/config";
import type { ShapeKind } from "@/demos/connectors/shapes";
import { useWebGPU } from "@/lib/use-webgpu";
import { ConnectorsDemoScene } from "./scene";

const d = CONNECTORS_DEFAULTS;

/** The interactive half of the demo page: the canvas, its controls, and the element the cursor is measured against. */
export function ConnectorsDemo() {
  ...
  // Leva types a select as plain `string`, so the union has to be restored on the way out.
