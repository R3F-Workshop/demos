...
/** The grain gradient on its own page, as the primary canvas, with every dial exposed: the point of this one is tuning it. */
export function GrainGradientStandalone() {
  ...
  return (
    <WebGPUGate>
      {/* Open by default here: a tuning page with a collapsed panel is a tuning page nobody tunes. */}
      <LevaPanel alwaysOpen />
      <Canvas
        id="main"
        // Opaque: on the marketing page this field lifts the section behind it, but here there is nothing behind it to lift.
